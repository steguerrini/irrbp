...
void CIrrBPDebugDrawer::drawLine(const btVector3& from, const btVector3& to, const btVector3& color)
{
	...
	this->vdriver->draw3DLine(bulletVectorToIrrVector(from),bulletVectorToIrrVector(to),irrcolor);
}
...
{
	irr::video::SColor irrcolor(255,color[0]*255,color[1]*255,color[2]*255);
	this->vdriver->draw3DLine(bulletVectorToIrrVector(PointOnB),bulletVectorToIrrVector(PointOnB + normalOnB * distance),irrcolor);
}
...
{
	irr::video::SColor irrcolor(255,color[0]*255,color[1]*255,color[2]*255);
	this->vdriver->draw3DTriangle(irr::core::triangle3df(bulletVectorToIrrVector(v0),bulletVectorToIrrVector(v1),bulletVectorToIrrVector(v2)),irrcolor);
}
