...
{
public:
	CIrrBP6DOFConstraint(CIrrBPRigidBody * bodyA,CIrrBPRigidBody * bodyB,const vector3df & pivotInA=vector3df(0,0,0),const vector3df & pivotInB=vector3df(0,0,0));
	CIrrBP6DOFConstraint(CIrrBPRigidBody * bodyA,const vector3df & pivotInA=vector3df(0,0,0));
	
	vector3df getAxis(int axis_index) const { return bullet::bulletVectorToIrrVector(m_fixedConstraint->getAxis(axis_index));}
