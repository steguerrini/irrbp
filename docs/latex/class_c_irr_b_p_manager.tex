...
\hypertarget{class_c_irr_b_p_manager_a58e4019b664a6f3be5500394c4950206}{
\index{CIrrBPManager@{CIrrBPManager}!addCollisionObjectToBulletQueue@{addCollisionObjectToBulletQueue}}
\index{addCollisionObjectToBulletQueue@{addCollisionObjectToBulletQueue}!CIrrBPManager@{CIrrBPManager}}
\subsubsection[{addCollisionObjectToBulletQueue}]{\setlength{\rightskip}{0pt plus 5cm}void CIrrBPManager::addCollisionObjectToBulletQueue (
\begin{DoxyParamCaption}
\item[{{\bf CIrrBPCollisionObject} $\ast$}]{ cobj}
\end{DoxyParamCaption}
)}}
\label{class_c_irr_b_p_manager_a58e4019b664a6f3be5500394c4950206}
Adds your own collision object to the bullet queue. You need to call this if you're not using the IrrBP manager to create a collision object 

Here is the call graph for this function:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=400pt]{class_c_irr_b_p_manager_a58e4019b664a6f3be5500394c4950206_cgraph}
\end{center}
\end{figure}


\hypertarget{class_c_irr_b_p_manager_a4014de850508351affc43026a34a70bb}{
\index{CIrrBPManager@{CIrrBPManager}!addPatchSoftBody@{addPatchSoftBody}}
\index{addPatchSoftBody@{addPatchSoftBody}!CIrrBPManager@{CIrrBPManager}}
\subsubsection[{addPatchSoftBody}]{\setlength{\rightskip}{0pt plus 5cm}{\bf CIrrBPPatchSoftBody} $\ast$ CIrrBPManager::addPatchSoftBody (
\begin{DoxyParamCaption}
\item[{const vector3df \&}]{ corner00, }
\item[{const vector3df \&}]{ corner01, }
\item[{const vector3df \&}]{ corner10, }
\item[{const vector3df \&}]{ corner11, }
\item[{irr::f32}]{ mass, }
\item[{s32}]{ resx, }
\item[{s32}]{ resy}
\end{DoxyParamCaption}
)}}
\label{class_c_irr_b_p_manager_a4014de850508351affc43026a34a70bb}
Adds a cloth (soft body) into the world. You must specify the 4 cloth' corners. 
\begin{DoxyParams}{Parameters}
\item[{\em corner00}]first corner \item[{\em corner01}]second corner \item[{\em corner10}]third corner \item[{\em corner11}]fourth corner \item[{\em mass}]patch's mass \item[{\em resx}]lenght resolution. More resolution, minor performance. \item[{\em resy}]depth resolution. More resolution, minor performance. \end{DoxyParams}
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{class_c_irr_b_p_manager_a4014de850508351affc43026a34a70bb_cgraph}
\end{center}
\end{figure}
...
Pointer to the object. 
\end{DoxyReturn}
\hypertarget{class_c_irr_b_p_manager_ae962ff163a13005f463aa51a351a0a87}{
\index{CIrrBPManager@{CIrrBPManager}!addRopeSoftBody@{addRopeSoftBody}}
\index{addRopeSoftBody@{addRopeSoftBody}!CIrrBPManager@{CIrrBPManager}}
\subsubsection[{addRopeSoftBody}]{\setlength{\rightskip}{0pt plus 5cm}{\bf CIrrBPRopeSoftBody} $\ast$ CIrrBPManager::addRopeSoftBody (
\begin{DoxyParamCaption}
\item[{const vector3df \&}]{ from, }
\item[{const vector3df \&}]{ to, }
\item[{irr::f32}]{ mass, }
\item[{int}]{ res = {\ttfamily -\/1}}
\end{DoxyParamCaption}
)}}
\label{class_c_irr_b_p_manager_ae962ff163a13005f463aa51a351a0a87}
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{class_c_irr_b_p_manager_ae6c1ebbc11dec61a856bcc7b5c6394ce_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{class_c_irr_b_p_manager_a8a61e921b487d6249e46022b6e9b5ccf_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{class_c_irr_b_p_manager_a87b2610eaba14775ac81992ff71ab436_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{class_c_irr_b_p_manager_a19a7a9108ded5c076d307efdb390d58a_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{class_c_irr_b_p_manager_a1a2dc64a93a8770dfed3ba7f77972c70_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{class_c_irr_b_p_manager_af916152de29ba8c7c9e727dfe5a1c8af_cgraph}
\end{center}
\end{figure}
...
Drops the bullet manager \hypertarget{class_c_irr_b_p_manager_a0dd849ddab18d640c2dff7847d305ac4}{
...
\subsubsection[{getRigidBodyFromId}]{\setlength{\rightskip}{0pt plus 5cm}{\bf CIrrBPCollisionObject}$\ast$ CIrrBPManager::getRigidBodyFromId (
\begin{DoxyParamCaption}
\item[{irr::s32}]{ id}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
\label{class_c_irr_b_p_manager_a0dd849ddab18d640c2dff7847d305ac4}
...
\end{DoxyReturn}
\hypertarget{class_c_irr_b_p_manager_a60406c7bd5c47ca75e46585644db3e0b}{
...
\subsubsection[{getRigidBodyFromName}]{\setlength{\rightskip}{0pt plus 5cm}{\bf CIrrBPCollisionObject}$\ast$ CIrrBPManager::getRigidBodyFromName (
\begin{DoxyParamCaption}
\item[{irr::c8 $\ast$}]{ name}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
\label{class_c_irr_b_p_manager_a60406c7bd5c47ca75e46585644db3e0b}
...
\end{DoxyReturn}
\hypertarget{class_c_irr_b_p_manager_a98905295ca376a5ab08e2e1fe13a17fe}{
...
\subsubsection[{getRigidBodyFromUId}]{\setlength{\rightskip}{0pt plus 5cm}{\bf CIrrBPCollisionObject}$\ast$ CIrrBPManager::getRigidBodyFromUId (
\begin{DoxyParamCaption}
\item[{irr::u32}]{ uid}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
\label{class_c_irr_b_p_manager_a98905295ca376a5ab08e2e1fe13a17fe}
